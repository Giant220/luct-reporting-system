      ...
      switch (type) {
        case 'reports':
          let reportsQuery = supabase
            ...
            .select(`*, classes (class_name, courses (course_code, course_name)), users!lecture_reports_lecturer_id_fkey (name as lecturer_name)`)
        ...
        default:
          ...
          results = { reports: reportsRes.data || [], courses: coursesRes.data || [], users: usersRes.data || [] }
      }
